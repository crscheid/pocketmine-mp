...
The current version in the built image: PocketMine-MP 1.7dev-698 with API 3.0.0-ALPHA11 [Github Release](https://github.com/pmmp/PocketMine-MP/releases/tag/1.7dev-698)
