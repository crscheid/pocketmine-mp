...
* `3.3.4`, `3.3`, `latest` [(3.3/Dockerfile)](https://github.com/crscheid/pocketmine-mp/blob/master/3.3/Dockerfile)
...
The latest version is PocketMine-MP 3.3.4 [Github Release](https://github.com/pmmp/PocketMine-MP/releases/tag/3.3.4). Versions are also maintained for 3.2.x and 3.1.x branches. Versions of this Docker image are tracked against PocketMine-MP's versioning scheme. Since this is not an official PocketMine-MP project, there may be a lag between new version releases of PocketMine-MP and this image.
